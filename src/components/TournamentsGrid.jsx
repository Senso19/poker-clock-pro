...
function TournamentCard({ t, badge, count, already, manage, canDuplicate, readOnly, busy, menuOpen, onOpen, onToggleRegister, onToggleMenu, onDelete, onDuplicate, onMarkFinished, winnerName }) {
  return (
    <div
      ...
      className="pcp-card-hover relative border border-felt-cream/10 rounded-xl p-4 flex flex-col hover:border-felt-cream/20 cursor-pointer"
    >
...
function TournamentRow({ t, badge, count, already, manage, canDuplicate, readOnly, busy, menuOpen, onOpen, onToggleRegister, onToggleMenu, onDelete, onDuplicate, onMarkFinished, winnerName }) {
  return (
    <div
      ...
      data-pcp-card
      style={{ backgroundColor: "var(--pcp-cell-bg, #1B2027)", color: "var(--pcp-cell-text, inherit)" }}
      className="pcp-card-hover relative flex flex-wrap items-center gap-4 border border-felt-cream/10 rounded-lg px-4 py-3 hover:border-felt-cream/20 cursor-pointer"
    >
